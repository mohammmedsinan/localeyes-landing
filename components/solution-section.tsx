  ...
  const solutions = [
    {
      ...
      description:
        "We'll make sure your place pops up higher on Google Maps and Apple Maps.",
      color: "text-blue-600",
      bgColor: "bg-blue-50",
    },
    {
      ...
      description:
        "We'll get you those 5-star reviews and build real trust with new diners.",
    ...
    <section id="solution-section" className="py-20 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            <p className="mb-6">
              Let's be realistic, you probably don't have the time or capacity
              to learn how the algorithm works, right? Well, that's where
              LocalEyes comes in.
            </p>
            <p className="mb-6 font-semibold text-blue-600">
              You don't need to learn about SEO or how to apply it to your
              business, because we'll handle it for you from A to Z.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <p className="text-xl leading-relaxed mb-6">
            And LocalEyes does all that and more for{" "}
            <strong>a fraction of the cost</strong> you would be paying for
        ...
        >
          ...
          <div className="bg-red-50 p-6 rounded-xl border-2 border-red-200">
            <h4 className="text-lg font-bold text-red-600 mb-4 text-center">
              ❌ BEFORE LocalEyes
            </h4>
          ...
          <div className="bg-green-50 p-6 rounded-xl border-2 border-green-200">
            <h4 className="text-lg font-bold text-green-600 mb-4 text-center">
              ✅ AFTER LocalEyes
            </h4>
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
